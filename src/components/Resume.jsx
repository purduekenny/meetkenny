...
function Resume () {
    return (
        <div className={styles.resumeHighlight}>
            <ResumeBlock name="Business & Communication Specialist" color="green" graphic="./assets/comm.png" alt='sattelite in space' description="In May 2024, I will receive my Master of Business Administration (MBA) from Purdue University's Mitchell E. Daniels, Jr. School of Business and the Krannert Graduate Institute.<br/>Additionally, I have my Master of Science (MS) in Strategic Communication from Brian Lamb School of Communication at Purdue University."></ResumeBlock>
