...
function Resume () {
    return (
        <div className={styles.resumeHighlight}>
            ...
            <ResumeBlock name="Project Management" color="border-color:red" graphic="./assets/pm.png" alt='sattelite in space' description="I have my Project Management Professional (PMP) certification from the PMI. I love managing creative projects and creative people."></ResumeBlock>
